namespace Shutdown_Helper
{
    partial class FormShutdown
    {
        ...
        private void InitializeComponent()
        {
        	...
        	// pictureBox1
        	// 
        	this.pictureBox1.Image = global::Shutdown_Helper.Properties.Resources.shutdown_icon;
        	...
        	this.label2.Text = "Simpan semua pekerjaan anda!!\r\nDalam waktu beberapa detik,,\r\nKomputer ini akan ma" +
        	"ti!!";
        	// 
        	// button1
        	// 
        	...
        	this.Icon = global::Shutdown_Helper.Properties.Resources.warning;
        	this.MaximizeBox = false;
        	this.MinimizeBox = false;
        	this.Name = "FormShutdown";
        	this.ShowInTaskbar = false;
        	this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
        	this.Text = "FormShutdown";
        	this.TopMost = true;
        	this.Load += new System.EventHandler(this.FormShutdownLoad);
